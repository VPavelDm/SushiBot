...
public class OnPriceUpProcessor extends OnSortChoseAbstractProcessor {
    ...
    public OnPriceUpProcessor(ItemRepository itemRepository, UserRepository userRepository, CategoryRepository categoryRepository, IngredientRepository ingredientRepository) {
