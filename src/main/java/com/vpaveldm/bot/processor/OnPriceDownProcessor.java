...
public class OnPriceDownProcessor extends OnSortChoseAbstractProcessor {
    public OnPriceDownProcessor(ItemRepository itemRepository, UserRepository userRepository, CategoryRepository categoryRepository, IngredientRepository ingredientRepository) {
